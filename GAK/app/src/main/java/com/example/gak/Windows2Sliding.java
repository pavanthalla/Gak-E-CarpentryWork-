...
public class Windows2Sliding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_windows2_sliding);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Windows2Sliding.this,"Item Added to Cart Successfully",Toast.LENGTH_LONG).show();
